  ...
  return (
    <div className="container">
      <div className="about-container py-5">
        ...
        <section className="my-4 mt-5">
          <h4>Human Resource Management & Consultation</h4>
          <p>
        ...
        <section className="my-4 mt-5">
          <h4>HR Policies & Procedure Development</h4>
          <p>
        ...
        <section className="my-4 mt-5">
          <h4>Employee Handbooks & Performance Management</h4>
          <p>
        ...
        <section className="my-4 mt-5">
          <h4>Employee Relations & Counseling</h4>
          <p>
        ...
        <section className="my-4 mt-5">
          <h4>Employee & Management Training Solutions</h4>
          <p>
